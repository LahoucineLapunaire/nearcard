    ...
    return Column(
      ...
      children: [
        Container(
            ...
            child: const Icon(Icons.email, size: 60, color: Colors.black)),
        const SizedBox(
          height: 16,
        ),
        const Text(
        ...
        const Text(
          'Veuillez saisir votre nouvelle adresse email',
          style: TextStyle(
            fontSize: 18,
            fontFamily: 'Montserrat',
              ...
              onPressed: () {
                try {
                  if (state.emailController.text.isEmpty) {
                    displayMessage(
                        context, "Veuillez saisir une adresse email.");
                    return;
                  }
                  auth.currentUser?.updateEmail(state.emailController.text);
                  state.emailController.clear();
                  displayMessage(context, "Votre email a été mis à jour !");
                  Navigator.of(context).pop();
                } catch (e) {
